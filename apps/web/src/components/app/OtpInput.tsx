        ...
        <div className="flex justify-between gap-2" onPaste={handlePaste}>
            {digits.map((digit, index) => (
                <input
                    ...
                    className="h-14 w-full rounded-xl border border-edge/80 bg-canvas text-center text-xl font-semibold text-ink focus:border-olive focus:bg-white focus:outline-none disabled:opacity-50"
                />
            ))}
        </div>
    );
