...
export default function NewShipmentPage() {
    ...
    return (
      <div className="mx-auto max-w-xl py-8 text-center">
        ...
        <div className="mt-6 flex justify-center gap-2">
          <Link to="/shipments" className="rounded-xl bg-olive-deep px-5 py-2.5 text-sm font-semibold text-bone-light hover:bg-olive-deep/90">View shipments</Link>
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <Link to="/shipments" className="mb-3 inline-flex items-center gap-1.5 text-sm text-muted hover:text-olive-deep">
